{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 468.0, 163.0, 640.0, 480.0 ],
		"bglocked" : 0,
		"defrect" : [ 468.0, 163.0, 640.0, 480.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t i i",
					"patching_rect" : [ 204.0, 36.0, 64.0, 18.0 ],
					"fontsize" : 10.0,
					"numinlets" : 1,
					"numoutlets" : 2,
					"id" : "obj-20",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "gate",
					"patching_rect" : [ 420.0, 116.0, 32.5, 18.0 ],
					"fontsize" : 10.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"id" : "obj-17",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b f",
					"patching_rect" : [ 380.0, 92.0, 32.5, 18.0 ],
					"fontsize" : 10.0,
					"numinlets" : 1,
					"numoutlets" : 2,
					"id" : "obj-4",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 476.0, 72.0, 158.0, 18.0 ],
					"fontsize" : 10.0,
					"numinlets" : 2,
					"numoutlets" : 0,
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					...
					"color" : [ 0.67451, 0.819608, 0.572549, 1.0 ],
					"patching_rect" : [ 476.0, 48.0, 154.0, 18.0 ],
					"fontsize" : 10.0,
					"numinlets" : 2,
					"numoutlets" : 0,
					"id" : "obj-1",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "* 2.",
					"patching_rect" : [ 420.0, 168.0, 32.5, 18.0 ],
					"fontsize" : 10.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"id" : "obj-6",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "8.",
					"patching_rect" : [ 420.0, 148.0, 50.0, 16.0 ],
					"fontsize" : 10.0,
					"numinlets" : 2,
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 436.0, 92.0, 40.0, 16.0 ],
					"fontface" : 0,
					"presentation" : 1,
					"parameter_enable" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "+ 0.",
					"patching_rect" : [ 420.0, 192.0, 32.5, 18.0 ],
					"fontsize" : 10.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"id" : "obj-26",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "- 0.",
					"patching_rect" : [ 384.0, 124.0, 30.5, 18.0 ],
					"fontsize" : 10.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"id" : "obj-19",
...
, 			{
				"box" : 				{
					"maxclass" : "inlet",
					"patching_rect" : [ 324.0, 4.0, 25.0, 25.0 ],
					"numinlets" : 0,
					"numoutlets" : 1,
					"id" : "obj-148",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "inlet",
					"patching_rect" : [ 384.0, 4.0, 25.0, 25.0 ],
					"numinlets" : 0,
					"numoutlets" : 1,
					"id" : "obj-149",
					"outlettype" : [ "" ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 333.5, 188.0, 201.0, 188.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"midpoints" : [ 333.5, 188.0, 443.0, 188.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"midpoints" : [ 333.5, 82.0, 389.5, 82.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 258.5, 113.5, 429.5, 113.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.047059, 0.0, 1.0, 1.0 ],
					"midpoints" : [ 258.5, 114.5, 193.5, 114.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 1.0, 1.0, 1.0 ],
					"midpoints" : [ 213.5, 86.0, 445.5, 86.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 429.5, 387.5, 193.5, 387.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 429.5, 190.5, 429.5, 190.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 393.5, 144.5, 460.5, 144.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 393.5, 144.5, 224.5, 144.5 ]
				}
